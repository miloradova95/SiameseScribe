...
@app.post("/explain_pair", response_model=ExplainPairResponse)
async def explain_pair(body: ExplainPairRequest):
    async with httpx.AsyncClient() as client:
        resp = await client.post(f"{ML_SERVICE_URL}/explain_pair", json=body.model_dump())
